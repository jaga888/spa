    ...
    <div class="senex__menu__left">
      ...
      <div class="two-columns-or-more senex__menu__item senex__menu__item--text senex__menu__item--submenu">
        ...
        <div class="senex__menu__submenu">
          ...
          <a class="senex__menu__submenu-item" href="/admin/reports/process-server-tracking/list">Process Server
            Tracking </a>
        </div>
      </div>
      ...
      <div class="two-columns-or-more senex__menu__item senex__menu__item--text senex__menu__item--submenu">
        Management
        <div class="senex__menu__submenu">
          <NuxtLink to="/management/clients" class="senex__menu__submenu-item">Clients & Properties</NuxtLink>
...
const {
  ...
  signOut,
  status
} = useAuth();// import the auth store we just created
