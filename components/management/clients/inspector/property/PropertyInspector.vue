...
import InformationTab from "~/components/management/clients/inspector/property/Tabs/Information/InformationTab.vue";
import PropertyButtons from "~/components/management/clients/inspector/property/PropertyButtons.vue";
import UnitFilter from "~/components/management/clients/inspector/property/UnitFilter.vue";
import NoteButtons from "~/components/management/clients/inspector/property/NoteButtons.vue";
import FeesTab from "~/components/management/clients/inspector/property/Tabs/Fees/FeesTab.vue";
import DocsTab from "~/components/management/clients/inspector/property/Tabs/Docs/DocsTab.vue";
import UnitsTab from "~/components/management/clients/inspector/property/Tabs/Units/UnitsTab.vue";
import NotesTab from "~/components/management/clients/inspector/property/Tabs/Notes/NotesTab.vue";
import type {Tab as TabType} from "~/services/tab/types";
import Tab from "~/components/management/clients/Tab.vue";
import Files from "~/components/management/clients/inspector/property/Tabs/Files/Files.vue";
