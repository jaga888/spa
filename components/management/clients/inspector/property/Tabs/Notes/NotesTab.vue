...
import Note from "~/components/management/clients/inspector/property/Tabs/Notes/Note.vue";
import {useNoteStore} from "~/store/note";
import NoteForm from "~/components/management/clients/inspector/property/Tabs/Notes/NoteForm.vue";
