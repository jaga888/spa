...
import ProcessingTypeComponent from "~/components/management/clients/inspector/property/Tabs/Notes/ProcessingTypeComponent.vue";
import Color from "~/components/management/clients/inspector/property/Tabs/Notes/Color.vue";
