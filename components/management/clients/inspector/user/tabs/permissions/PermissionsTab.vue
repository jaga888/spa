<template>
  <div class="senex__body user-permissions">
    <form class="senex__form senex__clients__permissions-form" method="post" action="/public">
...
import Property from "~/components/management/clients/inspector/user/tabs/permissions/Property.vue";
