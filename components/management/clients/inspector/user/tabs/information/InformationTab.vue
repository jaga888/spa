<template>
  <div class="senex__body user-information">
    <form class="senex__form senex__clients__info-form" method="post" action="/public">
      <BaseFieldset
...
import BaseFieldset from "~/components/management/clients/inspector/user/tabs/information/fieldset/BaseFieldset.vue";
import SignatureFieldset from "~/components/management/clients/inspector/user/tabs/information/fieldset/SignatureFieldset.vue";
