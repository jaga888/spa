...
import InformationTab from "~/components/management/clients/inspector/user/tabs/information/InformationTab.vue";
import PermissionsTab from "~/components/management/clients/inspector/user/tabs/permissions/PermissionsTab.vue";
import UserButtons from "~/components/management/clients/inspector/user/UserButtons.vue";
import PermissionButtons from "~/components/management/clients/inspector/user/PermissionButtons.vue";
