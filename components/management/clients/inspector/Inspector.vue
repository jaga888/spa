...
import CompanyInspector from "~/components/management/clients/inspector/company/CompanyInspector.vue";
import {useClientStore} from "~/store/client";
import {usePropertyStore} from "~/store/property";
import {useCompanyStore} from "~/store/company";
import {useUserStore} from "~/store/user";
import PropertyInspector from "~/components/management/clients/inspector/property/PropertyInspector.vue";
import UserInspector from "~/components/management/clients/inspector/user/UserInspector.vue";
